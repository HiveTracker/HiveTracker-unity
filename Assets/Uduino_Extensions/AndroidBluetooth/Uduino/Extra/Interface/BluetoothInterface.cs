...
namespace Uduino
{
    ...
    public class BluetoothInterface : MonoBehaviour
    {
        ...
        UduinoConnection_AndroidBluetoothLE bleCommunication = null;
        ...
        public void SetBLEConnection(UduinoConnection_AndroidBluetoothLE connection)
        {
        ...
        Text getScanButton()
        {
            return UduinoManager.Instance.interfaceType == AndroidInterface.Full ?
        ...
        {
            return UduinoManager.Instance.interfaceType == AndroidInterface.Full ? deviceButton : deviceButtonMinimal;
        }
        GameObject getErrorPanel()
        {
            return UduinoManager.Instance.interfaceType == AndroidInterface.Full ? errorPanel : minimalErrorPanel;
        }

        GameObject getNotFound()
        {
            return UduinoManager.Instance.interfaceType == AndroidInterface.Full ? notFound : minimalNotFound;
        }
        ...
        {
            if (UduinoManager.Instance.interfaceType == AndroidInterface.None)
                return;
