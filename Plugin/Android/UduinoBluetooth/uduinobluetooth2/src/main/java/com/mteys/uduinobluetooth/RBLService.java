...
public class RBLService extends Service {
    ...
    public boolean connect(final String address) {
        ...
        if (mBluetoothDeviceAddress != null
            ...
            if (mBluetoothGatt.connect()) {
                ...
                Log.e(TAG,"coooooooooooooonnect");
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        Log.w(TAG, "UUID of the device are " +characteristic);
    ...
    public void setCharacteristicNotification(
        ...
        Log.w(TAG, "UUID of the device are " + characteristic.getUuid());
        ...
        if (UUID_BLE_SHIELD_RX.equals(characteristic.getUuid())) {
            ...
            if(descriptor != null) {
                ...
                Log.e(TAG, "Error finding the descriptor !");
            }
        }
    }
